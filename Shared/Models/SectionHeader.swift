...
struct SectionHeader {
    ...
    func getTranslations() -> [Translation] {
        ...
        translations.append(Translation(definition: "Virtual Address", humanReadable: self.addr.hex, bytesCount: self.is64Bit ? 8 : 4, translationType: self.is64Bit ? .uint64 : .uint32))
        translations.append(Translation(definition: "Section Size", humanReadable: self.size.hex, bytesCount: self.is64Bit ? 8 : 4, translationType: self.is64Bit ? .uint64 : .uint32))
        translations.append(Translation(definition: "File Offset", humanReadable: self.offset.hex, bytesCount: 4, translationType: .uint32))
        translations.append(Translation(definition: "Align", humanReadable: "\(self.align)", bytesCount: 4, translationType: .uint32))
        translations.append(Translation(definition: "Reloc Entry Offset", humanReadable: self.fileOffsetOfRelocationEntries.hex, bytesCount: 4, translationType: .uint32))
        translations.append(Translation(definition: "Reloc Entry Number", humanReadable: "\(self.numberOfRelocatioEntries)", bytesCount: 4, translationType: .uint32))
        ...
        translations.append(Translation(definition: self.sectionType.hasIndirectSymbolTableEntries ? "Indirect Symbol Table Index" : "reserved1", humanReadable: self.reserved1.hex, bytesCount: 4, translationType: .uint32))
        translations.append(Translation(definition: self.sectionType == .S_SYMBOL_STUBS ? "Stub Size" : "reserved2", humanReadable: self.reserved2.hex, bytesCount: 4, translationType: .uint32))
        if let reserved3 = self.reserved3 { translations.append(Translation(definition: "reserved3", humanReadable: reserved3.hex, bytesCount: 4, translationType: .uint32)) }
        return translations
    }
